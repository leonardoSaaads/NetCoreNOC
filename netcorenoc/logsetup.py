...
F3's primary fix is discipline — NetCoreNOC never logs a secret (the bootstrap banner is the
...
_PATTERNS = [
    ...
    re.compile(r"(?i)(netcorenoc_session=)([^\s;]+)"),
]
...
class JsonFormatter(logging.Formatter):
    """Minimal structured JSON log lines (NETCORENOC_LOG_JSON=1)."""
