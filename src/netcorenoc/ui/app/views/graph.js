...
export class GraphView extends Component {
  ...
  draw() {
    ...
    selection
      .attr("r", (d) => NODE_BASE_RADIUS + 2.5 * Math.sqrt(d.active_alarms))
  ...
  render(_props, { live }) {
    ...
    return html`<div class="graphview">
      <p class="hint">Every edge is a learned affinity between two network elements: how often
        ...
        inferred from the trap stream. Opacity and thickness both encode the weight.</p>
      ${empty ? html`<${Empty}
      ...
      ${!empty ? html`<p class="hint">
        ...
        text, which is where an operator who cannot use it should go. Naming that is deliberate:
        see <code>docs/gates/v0.13.0-phase-6.md</code>.</p>` : null}
    </div>`;
  }
}
