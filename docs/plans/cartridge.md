...
**Implement none of this.** Every element below is tagged **`v0.17.3: planned`**.
...
## 1. What is actually out of reach (`v0.17.3: planned`)
...
## 2. The opinion this release forms (`v0.17.3: planned`)
...
## 3. What is inherited unchanged from the v0.14.0 draft (`v0.17.3: planned`)
...
## 4. What should happen instead, first (`v0.17.3: planned`)
...
## 4a. The worker-process preemption harness, which is a blocking prerequisite (`v0.17.3: planned`)
...
## 5. What this draft must not become (`v0.17.3: planned`)
...
## 6. What v0.16.1 learned that this plan has to hold (`v0.17.3: planned`)
