...
**Implement none of this.** Every element below is tagged **`v0.18.1: planned`**.
...
## 0. The uncomfortable fact this draft starts from (`v0.18.1: planned`)
...
## 1. What an archetype is: three candidates, none chosen here (`v0.18.1: planned`)
...
## 2. What is already in place, unchanged (`v0.18.1: planned`)
...
## 3. What the release must decide in advance (`v0.18.1: planned`)
...
## 4. What v0.11.0 recommends against, from what it measured (`v0.18.1: planned`)
